...
<html lang="en">
  ...
  <head>
    ...
    <!-- Title of Website -->
    <title>Karan Khemani &ndash; Coming Soon Landing Page</title>
  ...
  <body data-spy="scroll" data-target=".scrollspy" class="bg-dark">
    ...
    <div class="loader bg-dark">
      <div
        class="loader-inner ball-scale-ripple-multiple ball-scale-ripple-multiple-bw"
      >
        <div></div>
        <div></div>
        <div></div>
          ...
          <div>
            ...
            <div class="modal-content text-center bg-dark text-light">
              <button
                ...
                aria-label="Close"
              >
                <i class="icon icon-lg icon-arrows-remove"></i>
              </button>
              ...
              <div class="p-t-b-30">
                <form id="mc-form">
                  ...
                  <div class="input-group">
                    ...
                    <span class="input-group-btn">
                      <button type="submit" class="btn btn-white">
                        <i
                          class="icon icon-sm icon-arrows-slim-right-dashed"
                        ></i>
                      </button>
                    </span>
                  </div>
                  ...
                  <div
                    ...
                    class="message-wrapper text-white message"
                  >
                    <span
  ...
  ================================= -->
      ...
      ================================= -->
          ...
          <div
            id="info"
            class="col-md-12 text-white text-center page-info col-transform"
          >
            <div class="vert-middle">
              <div class="reveal scale-out">
                <!-- Count Down -->
                <!-- <div
                  class="count-down p-t-b-15"
                  data-end-date="Nov 20, 2019 00:00:00"
                ></div> -->
                <!-- /End Count Down -->
                ...
                <div class="p-t-b-15">
                  ...
                  <h2>
                    <span class="font-weight-200">Before launching our</span
                    ><br />new Website
                  </h2>

                  <p>
                    We're coming soon! Awesome template to present your future
                    product or service.<br />We're working hard to give you the
                    best experience!<br />
                  </p>
                ...
                <!-- <div class="p-t-b-15 btn-row">
                  ...
                  <a
                    class="btn btn-border-white show-info"
                    role="button"
                    data-href="#content"
                  >
                    More info
                ...
                <div class="p-t-b-30">
                  <p>
                    <a
                      href="https://www.facebook.com/egotypes"
                      class="link-white"
                      ><i class="fa fa-facebook"></i
                    ></a>
                    <a href="https://twitter.com/egotype" class="link-white"
                      ><i class="fa fa-twitter"></i
                    ></a>
                    <a href="https://plus.google.com/" class="link-white"
                      ><i class="fa fa-google-plus"></i
                    ></a>
                    <a href="https://www.behance.net/egotype" class="link-white"
